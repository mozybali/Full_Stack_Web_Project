  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white mb-6"
        >
          <FaArrowLeft />
          <span>Geri Dön</span>
        </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
            ...
            <div>
              <div className="mb-4">
                <span className="inline-block bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200 px-3 py-1 rounded-full text-sm font-semibold">
              ...
              {product.description && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold dark:text-white mb-2">Açıklama</h3>
              ...
              <div className="border-t dark:border-gray-700 pt-6">
                ...
                {product.stock > 0 ? (
                  ...
                  <div className="bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-200 px-4 py-3 rounded">
