        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400 dark:text-gray-500">
              <li><a href="/" className="hover:text-white dark:hover:text-gray-300 transition-colors">Ana Sayfa</a></li>
              <li><a href="/products" className="hover:text-white dark:hover:text-gray-300 transition-colors">Ürünler</a></li>
              <li><a href="/about" className="hover:text-white dark:hover:text-gray-300 transition-colors">Hakkımızda</a></li>
              <li><a href="/contact" className="hover:text-white dark:hover:text-gray-300 transition-colors">İletişim</a></li>
            </ul>
          </div>
